...
<!--              <img class="h-full object-contain" alt="galléria" :src="`gallery/${image}`">-->
              <NuxtImg loading="lazy" sizes="xs:480px sm:640px md:768px lg:960px" class="h-full object-contain" format="webp" :src="`http://localhost:3000/gallery/${image}`" alt="galléria" />
            </div>
          </div>
        </swiper-slide>
